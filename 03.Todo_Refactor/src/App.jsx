...
function App({counter, onIncrement, onDecrement, onRestart}) {
  ...
  return (
    <div class="flex flex-col items-center justify-center mt-44">
      ...
      <button type="button" onClick={onRestart} className="py-2.5 px-5 mt-4 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">ریست</button>
